...
import { Sparkline, TrendDelta, PlayerCell, MatchupBars, RiskDot, TabBar } from "@/components/product/primitives"
import { IconSearch } from "@/components/product/icons"
...
export function RankingsView({ onSelectPlayer }) {
  
  const [pos, setPos] = useState("ALL");
  const [scoring, setScoring] = useState("ppr");
  const [search, setSearch] = useState("");  const filtered = PLAYERS
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: 24, flexWrap: "wrap", gap: 16 }}>
        ...
        <div style={{ display: "flex", gap: 10, alignItems: "center", flexWrap: "wrap" }}>
          ...
          <div style={{
            ...
            <IconSearch size={14} stroke="var(--slate)" />
