...
import { Sparkline, PlayerCell, MatchupBars, SectionTitle } from "@/components/product/primitives"
import { IconBolt, IconClose, IconSwap } from "@/components/product/icons"
import { StadiumMap } from "@/components/product/views/stadium-map"

export function LineupView({ onSelectPlayer }: { onSelectPlayer?: (p: import("@/lib/mock").Player) => void }) {
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: 24, flexWrap: "wrap", gap: 16 }}>
        ...
        <div style={{ display: "flex", gap: 10 }}>
          ...
          <button className="btn" onClick={optimize}>
            <IconBolt size={14} stroke="var(--black)" />
            Auto-optimize
          </button>
        </div>
      </div>
    ...
    <div onClick={onClose} style={{
      ...
      <div onClick={e => e.stopPropagation()} style={{
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 18 }}>
          ...
          <button onClick={onClose} style={{ background: "transparent", border: "none", color: "var(--slate)", cursor: "pointer", padding: 4 }}><IconClose size={18} /></button>
        </div>
