...
|---|---:|---|---|---|
| Supabase Postgres | V0 | Normalized players, teams, franchises, rosters, lineups, draft rooms, projections, rankings, tiers, scores, provider mappings | All pages | Primary 949 source of truth. UI should read 949 APIs backed by Supabase. |
...
| Free NFL data source | V0 | Players, teams, schedule, basic stats, basic game logs if available | V0 testing for Analytics, Rankings, Start/Sit, Player Tape | Good enough to test data shape, not final source of truth. |
