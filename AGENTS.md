...
Product briefs: [docs/product-context.md](docs/product-context.md). **GM/Coach evaluators:** [docs/evaluator-layering-spec.md](docs/evaluator-layering-spec.md). **Env (Vercel + `.env.local`):** [docs/vercel-env-plan.md](docs/vercel-env-plan.md). **V0 data:** [docs/v0-roster-stats-bridge.md](docs/v0-roster-stats-bridge.md). **Wiring:** [docs/cursor-piping-handoff.md](docs/cursor-piping-handoff.md). **Metrics:** [docs/metrics-glossary.md](docs/metrics-glossary.md). Routes: [docs/ia-routes.md](docs/ia-routes.md).
