...
function StatisticsView({ tab, setTab, onSelectPlayer }) {
  return (
...
function PlayerTrendsView({ onSelectPlayer }) {
  ...
  const [source, setSource] = React.useState("roster"); // roster / waiver
  const [pickId, setPickId] = React.useState("jchase");
