function SnapshotView({ onNavigate, onSelectPlayer }) {
  const { TEAM_POSITION_WEEKS, TEAM_FUTURE_WEEKS, POSITION_PERFORMANCE, NEWS } = window;
...
function YourVsFieldCard() {
  ...
  const [pos, setPos] = React.useState("RB");
...
Object.assign(window, { SnapshotView, DashboardView });